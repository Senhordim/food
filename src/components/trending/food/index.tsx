...
export function FoodItem({ food }: {food: FoodProps } ) {
  return (
    <Pressable className='flex flex-col rounded-xl relative'>
        ...
        />
        <View className='flex flex-row bg-neutral-900/90 gap-1 absolute rounded-full top-2 right-3 px-2 py-1 items-center justify-center '>
            <Ionicons name='star' size={14} color="#ca8a" />
